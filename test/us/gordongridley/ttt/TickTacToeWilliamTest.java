...
import us.gordongridley.ttt.TickTacToeWilliam;


public class TickTacToeWilliamTest {
	@Test
	public void testCase1FirstRow(){
		String[] args = {"1", "4", "2", "5", "3", "4"};
		Assert.assertEquals(TickTacToeWilliam.X_WINS, TickTacToeWilliam.gamePlay(args));
	}
	
	@Test
	public void testCase2SecondRow(){
		String[] args = {"1", "4", "2", "5", "7", "6", "3"};
		Assert.assertEquals(TickTacToeWilliam.O_WINS, TickTacToeWilliam.gamePlay(args));
	}
	...
	public void testCase9Tie1(){
		...
		Assert.assertEquals(TickTacToeWilliam.TIE, TickTacToeWilliam.gamePlay(args));
	}
