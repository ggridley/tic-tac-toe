...
import us.gordongridley.ttt.TickTacToe;
...
public class TickTacToeTest {
	...
	public void testCase1FirstRow(){
		...
		Assert.assertEquals(TickTacToe.X_WINS, TickTacToe.gamePlay(args));
	}
	
	@Test
	public void testCase2SecondRow(){
		String[] args = {"1", "4", "2", "5", "7", "6", "3"};
		Assert.assertEquals(TickTacToe.O_WINS, TickTacToe.gamePlay(args));
	}
	...
	public void testCase9Tie1(){
		...
		Assert.assertEquals(TickTacToe.TIE, TickTacToe.gamePlay(args));
	}
